            ...
            <div class = "row row-grid justify-content-between">
                <div class = "col-lg-5">
                    ...
                    <tabs :fill = "false" circle>
                        <tab-pane>
                            <span class = "nav-link-icon d-block" slot = "title"><i class = "ni ni-atom"></i></span>
                        </tab-pane>
                        <tab-pane>
                            <span class = "nav-link-icon d-block" slot = "title"><i class = "ni ni-chat-round"></i></span>
                        </tab-pane>
                        <tab-pane>
                            <span class = "nav-link-icon d-block" slot = "title"><i
